...
function calculate(value) {
  if (value === "clear") {
    ...
    result.value = Math.sqrt(result.value); //hace la raiz cuadrada del numero ingresado
  } else if (value === "Math.sin(") {
    result.value = eval(Math.sin(result.value)); //hace el seno del numero ingresado
  } else if (value === "Math.cos(") {
    result.value = eval(Math.cos(result.value)); //hace el coseno del numero ingresado
  } else if (value === "Math.tan(") {
    result.value = eval(Math.tan(result.value)); //hace la tangente del numero ingresado
  } else if (value === "Math.log(") {
    result.value = eval(Math.log(result.value)); //hace el logaritmo del numero ingresado
  } else {
